...
<Container
    ...
    >
<Form onSubmit={handleSubmit}  style={{ width: '400px', padding: '20px', margin: '20px' ,border:'1px solid'}}>
      <Form.Group controlId="couponName">
        ...
        {validationErrors.couponName && (
          <div className="invalid-feedback">{validationErrors.couponName}</div>
        )}
      </Form.Group>
      <br />
      <Form.Group controlId="discount">
        ...
        {validationErrors.discount && (
          <div className="invalid-feedback">{validationErrors.discount}</div>
        )}
      </Form.Group>
      <br />
      ...
      <Form.Group controlId="minPurchase">
        ...
        {validationErrors.minPurchase && (
          <div className="invalid-feedback">{validationErrors.minPurchase}</div>
        )}
      </Form.Group>
<br />
