  ...
  return (
    <div className='orders-main'>
        ...
        <div className='orders-list'>
            <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',width:'1200px',marginTop:'20px',borderBottom:'1px solid'}}>
                <h6>Order_id</h6>
                <h6>hotelName</h6>
                <h6>CheckIn</h6>
                <h6>CheckOut</h6>
            ...
            {orderDetails.map((orderData,index) => (
                <div key={index} className='order-details'>
                    ...
                    <p><b>{orderData?.hotel.hotelName}</b></p>
