...
export const HotelPage = () => {
  ...
  const addReview = async () => {
    try {
      ...
      const response = await axios.post(
        `/api/users/review/${userId}/${hotelId}`,
        reviewTosend
      );
  ...
  const sendDetails = async () => {
    try {
      ...
      const response = await axios.post(
        `/api/users/hotelbooking/${userId}/${hotelId}`,
        dataToSend
      );
      ...
      <div style={{ margin: "20px" }}>
        ...
        <div className="date-picker">
          <div className="form-group">
            <label htmlFor="checkin" style={{ display: "flex" }}>
              Check-In Date
            </label>
            <DatePicker
              selected={startDate}
          ...
          <div className="form-group">
            <label htmlFor="checkout" style={{ display: "flex" }}>
              Check-Out Date
            </label>
            <DatePicker
              selected={endDate}
        ...
        <div style={{ display: "flex" }}>
          <div className="h-name">
            ...
            <h6 className="property-type">{hotel?.propertyType}</h6>
            <div>
              <MapPinLine size={18} color="green" />
              {hotel?.location}
            </div>
          ...
          <div className="booking">
            <div className="price-div">
              <div className="price-section">₹{hotel?.price}/-</div>
              <div>
                {" "}
                <b>per night</b>
              </div>
          ...
          <Modal.Body>
            <div className="modal-all">
              <div className="modal-button">
                ...
                <button onClick={handleDecreaseRooms}>
                  <MinusCircle size={18} />
                </button>
                <h6>{numRooms}</h6>
                <button onClick={handleIncreaseRooms}>
                  <PlusCircle size={18} />
                </button>
              </div>
              <div className="modal-button">
                ...
                <button onClick={handleDecreasePeople}>
                  <MinusCircle size={18} />
                </button>
                <h6>{numPeople}</h6>
                <button onClick={handleIncreasePeople}>
                  <PlusCircle size={18} />
                </button>
              </div>
            </div>
            ...
            {hotel?.amenities?.map((amenity, index) => (
              <div key={index}>
                <div className="amenities">
                  <h5>
                    <CheckCircle size={28} color="#00ff00" />
                    {amenity}
                  </h5>
                </div>
              </div>
        ...
        <div style={{ display: "flex" }}>
          <div className="review-page">
            ...
            <button
              ...
              onClick={handleShowDifferentModal}
            >
              Submit
            </button>
              ...
              <div key={index} className="single-review">
                <div className="review-name-rating">
                  ...
                  <p style={{ marginRight: "10px" }}>
                    <p style={{ color: "orange" }}>{review.rating}/5</p>
                  </p>
                </div>
