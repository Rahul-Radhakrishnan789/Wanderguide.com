    ...
    try {
      if (wishlistItems.includes(hotelId)) {
        ...
        const response = await axios.delete(
          `/api/users/removefromwishlist/${userId}`,
          {
        ...
        const response = await axios.post(
          `/api/users/addtowishlist/${userId}`,
          {
            hotelId: hotelId,
          }
        );
          ...
          >
            <div className="hotel-item" style={{ diaplay: "flex" }}>
              ...
              <div
                ...
                onClick={() => nav(`/hotelpage/${hotel._id}`)}
              >
                <div>
                ...
                <div className="hotel-location">
                  <p style={{ color: "green" }}>
                    <AnchorSimple size={17} /> {hotel.location}
                  </p>
                </div>
                ...
                <div className="flex-container">
                  ...
                  <div className="amenity-box">more+</div>
                </div>
              ...
              <button
                className={`heart ${
                  wishlistItems.includes(hotel._id) ? "active" : ""
                }`}
